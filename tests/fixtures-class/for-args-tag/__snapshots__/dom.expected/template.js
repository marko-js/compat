...
_marko_template._ = _marko_renderer(function (input, out, _componentDef, _component, state, $global) {
  ...
  for (const color of colorsArray) {
    ...
    out.be("li", null, "0" + _keyScope, _component, null, 0);
  ...
  for (const color of (() => {
    ...
    out.be("li", null, "1" + _keyScope2, _component, null, 0);
    out.t(color, _component);
    out.ee();
  }
  let _index10 = 0;
  for (const color of colorsArray) {
    ...
    out.be("li", null, "2" + _keyScope3, _component, null, 0);
    out.t(color, _component);
    out.ee();
  }
  let _index11 = 0;
  ...
  for (const color of _all) {
    ...
    if (loop.isFirst()) {
      out.be("div", null, "3" + _keyScope4, _component, null, 0, {
  ...
  for (const color of (() => {
    ...
    out.be("li", null, "4" + _keyScope5, _component, null, 0);
    out.t(color, _component);
    out.ee();
  }
  let _index13 = 0;
  ...
  for (const color in colorCodes) {
    ...
    out.be("li", null, "5" + _keyScope6, _component, null, 0);
    out.t(color, _component);
    out.t(": #", _component);
  ...
  for (const [color, code] of Object.entries(colorCodes)) {
    ...
    out.be("li", null, "6" + _keyScope7, _component, null, 0);
    out.t(color, _component);
    out.t(": #", _component);
    out.t(code, _component);
    out.ee();
  ...
  for (const [color, code] of _all5) {
    ...
    out.be("li", null, "7" + _keyScope8, _component, null, 0);
    out.t(color, _component);
    out.t(": #", _component);
    out.t(code, _component);
    out.ee();
  ...
  for (const [color, code] of _all6) {
    ...
    out.be("li", null, "8" + _keyScope9, _component, null, 0);
    out.t(color, _component);
    out.t(": #", _component);
    out.t(code, _component);
    out.ee();
  ...
  for (let _steps = (10 - 0) / 1, _step = 0; _step <= _steps; _step++) {
    const i = 0 + _step * 1;
    const _keyScope10 = `[${i}]`;
    out.be("li", null, "9" + _keyScope10, _component, null, 0);
    out.t(i, _component);
    out.ee();
  }
}, {
