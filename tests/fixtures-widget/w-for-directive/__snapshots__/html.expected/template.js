...
_marko_template._ = _marko_renderer(function (input, out, _componentDef, _component, state, $global) {
  ...
  out.w("a");
  out.w("</label>");
  out.w(`<input${_marko_props(out, _componentDef, 0, "@b", _componentDef)}${_marko_attr("id", _componentDef.elId("b"))}>`);
  out.w(`<label${_marko_attr("for", _componentDef.elId("b"))}>`);
  out.w("b");
  out.w("</label>");
  out.w(`<input${_marko_props(out, _componentDef, 0, "@c", _componentDef)}${_marko_attr("id", _componentDef.elId("c"))}>`);
