...
import { isIdentifierOrStringNamed } from "./identifier-or-string";

export function renderCallToDynamicTag(
...
export function replaceRenderCallExpression(
  node: t.Expression,
...
export function replaceRenderCallStatements(
  node: t.Statement,
  body: t.MarkoTagBody["body"],
): boolean {
  switch (node.type) {
